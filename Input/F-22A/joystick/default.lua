...
-------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	{down = iCommandPlaneCobra, name = _('FCS Direct AOA Control'), category = _('Flight Control')},	--NIGHTSTORM FCS HIGH AOA	
    -- Systems
...
--    {down = iCommandPlane_HOTAS_NoseWheelSteeringButton, up = iCommandPlane_HOTAS_NoseWheelSteeringButton, name = _('Nose Gear Maneuvering Range'), category = _('Systems')},
    ...
    {down = iCommandChangeGunRateOfFire, name = _('Cannon Rate Of Fire / Cut Of Burst select'), category = _('Weapons')},		--NIGHTSTORM enabled command
    })
    -- joystick axes 
