...
ILS_TEXT.element_params 	    = {"UFD_OPACITY","R_ADI_OPACITY","ILSN_VIS"}
...
NAV_TEXT.element_params 	    = {"UFD_OPACITY","R_ADI_OPACITY","NAV_VIS"}
...
INS_TEXT.level 						= 2
INS_TEXT.init_pos 			    	= {-60.0, -43.5, 0}
INS_TEXT.init_rot 			    	= {0, 0, 0}
INS_TEXT.element_params 	    	= {"R_ADI_OPACITY","UFD_OPACITY",}
...
UFD1.init_rot 			= {0, 0, 0}
UFD1.element_params 	= {"R_ADI_OPACITY","UFD_OPACITY",} --HOPE THIS WORKS G_OP_BACK
UFD1.controllers		= {{"parameter_in_range",0,0.9,1.1},
								{"opacity_using_parameter",1},
								}
Add(UFD1)
----------------------------------------------------------------------------------------
...
UFD2.init_rot 			= {0, 0, 0}
UFD2.element_params 	= {"R_ADI_OPACITY","UFD_OPACITY",} --HOPE THIS WORKS G_OP_BACK
...
UFD3.init_rot 			= {0, 0, 0}
UFD3.element_params 	= {"R_ADI_OPACITY","UFD_OPACITY",} --HOPE THIS WORKS G_OP_BACK
...
FUEL.init_rot 			= {0, 0, 0}
FUEL.element_params 	= {"R_ADI_OPACITY","UFD_OPACITY",} --HOPE THIS WORKS G_OP_BACK
...
E.init_pos 				= {36, 30	, 0}
E.init_rot 				= {0, 0, 0}
E.element_params 		= {"R_ADI_OPACITY","UFD_OPACITY",} --HOPE THIS WORKS G_OP_BACK
...
BGROUND6.element_params 		= {"R_ADI_OPACITY"} --HOPE THIS WORKS G_OP_BACK
...
VVI_NUM.level				= 6
VVI_NUM.element_params		= {"UFD_OPACITY","VV","R_ADI_OPACITY"}
...
FUELLINE.init_pos 			= {43, -77, 0} --maybe its x,y,z z being depth...
--FUELLINE.init_rot 			= {0, 0, 0}
...
FUELLINEMASKLOWER.init_pos 				= {43, -154, 0} --maybe its x,y,z z being depth...
FUELLINEMASKLOWER.element_params 		= {"FUELL","R_ADI_OPACITY"}
...
UFD4.init_rot 			= {0, 0, 0}
UFD4.element_params 	= {"R_WAR_OPACITY","UFD_OPACITY",} --HOPE THIS WORKS G_OP_BACK
...
UFD5.init_rot 			= {0, 0, 0}
UFD5.element_params 	= {"R_WAR_OPACITY","UFD_OPACITY",} --HOPE THIS WORKS G_OP_BACK
...
UFD6.init_rot 			= {0, 0, 0}
UFD6.element_params 	= {"R_WAR_OPACITY","UFD_OPACITY",} --HOPE THIS WORKS G_OP_BACK
...
SWAP.init_rot 			= {0, 0, 0}
SWAP.element_params 	= {"R_WAR_OPACITY","UFD_OPACITY",} --HOPE THIS WORKS G_OP_BACK
...
MENU1_TEXT.element_params 	    	= {"R_WAR_OPACITY","UFD_OPACITY",}
...
MENU2_TEXT.element_params 	    	= {"R_WAR_OPACITY","UFD_OPACITY",}
...
MENU3_TEXT.element_params 	    	= {"R_WAR_OPACITY","UFD_OPACITY",}
...
MENU4_TEXT.element_params 	    	= {"R_WAR_OPACITY","UFD_OPACITY",}
...
CENTERBAYCOPEN.element_params 		= {"UFD_OPACITY","BAY_C_ARG","R_WAR_OPACITY"}
...
--LEFTBAYCOPEN.element_params 	= {"UFD_OPACITY","BAY_L_ARG","R_WAR_OPACITY"}
--LEFTBAYCOPEN.controllers		= {{"opacity_using_parameter",0},{"parameter_in_range",1,0.9,1.1},{"parameter_in_range",2,0.01,1.2}}
LEFTBAYCOPEN.element_params 	= {"UFD_OPACITY","R_WAR_OPACITY","BAY_L_ARG","BAY_STATION"}	--LEFT side will ONLY light up IF the left bay is selected.
...
RIGHTBAYCOPEN.element_params 	= {"UFD_OPACITY","BAY_R_ARG","R_WAR_OPACITY"}
...
MACH_TXT.element_params 	        = {"UFD_OPACITY","R_WAR_OPACITY"}
...
M_NUM.level				    		= 10
M_NUM.element_params				= {"UFD_OPACITY","MACH","R_WAR_OPACITY"}
...
WARNING_BARO.element_params			= {"UFD_OPACITY","BAROALT","R_WAR_OPACITY"}
...
WARNING_RADALT.element_params		= {"UFD_OPACITY","RADALT","R_WAR_OPACITY"}
...
T_NUM.element_params		= {"UFD_OPACITY","TAS","R_WAR_OPACITY"}
...
I_NUM.element_params		= {"UFD_OPACITY","IAS","R_WAR_OPACITY"}
...
IFF_TEXT.element_params 	    	= {"R_WAR_OPACITY","UFD_OPACITY",}
...
INS_TEXT.init_rot 			    	= {0, 0, 0}
INS_TEXT.element_params 	    	= {"R_WAR_OPACITY","UFD_OPACITY",}
...
VV_TXT.value 				    = "VVI:"
VV_TXT.stringdefs 		        = {0.0040, 0.0040, 0.0004, 0.001}
...
VV_TXT.element_params 	        = {"UFD_OPACITY","R_WAR_OPACITY"}
...
VV_NUM.level				= 10
VV_NUM.element_params		= {"UFD_OPACITY","VV","R_WAR_OPACITY"}
...
GMT_TEXT.element_params 	    	= {"R_WAR_OPACITY","UFD_OPACITY",}
...
GMT_hours.level							= 10
GMT_hours.element_params				= {"UFD_OPACITY","GMT_HOURS","R_WAR_OPACITY"}
...
TIME2_TEXT.element_params 	    		= {"R_WAR_OPACITY","UFD_OPACITY",}
...
GMT_mins.level							= 10
GMT_mins.element_params					= {"UFD_OPACITY","GMT_MINS","R_WAR_OPACITY"}
...
TIME1_TEXT.element_params 	    		= {"R_WAR_OPACITY","UFD_OPACITY",}
...
GMT_sec.level							= 10
GMT_sec.element_params					= {"UFD_OPACITY","GMT_SECS","R_WAR_OPACITY"}
...
MISSION_HOURS.element_params				= {"UFD_OPACITY","MISSION_HOURS","R_WAR_OPACITY"}
...
TIME4_TEXT.element_params 	    		= {"R_WAR_OPACITY","UFD_OPACITY",}
...
MISSION_MINS.element_params				= {"UFD_OPACITY","MISSION_MINS","R_WAR_OPACITY"}
...
TIME3_TEXT.element_params 	    		= {"R_WAR_OPACITY","UFD_OPACITY",}
...
MISSION_SECS.element_params				= {"UFD_OPACITY","MISSION_SECS","R_WAR_OPACITY"}
